...
class Screen: NSObject {
    ...
    class func IS_IPHONE_4 () -> Bool{
        return UIDevice.current.userInterfaceIdiom == .phone && Screen.SCREEN_MAX_LENGTH() == 480.0
    }
    
    class func IS_IPHONE_5 () -> Bool{
        return UIDevice.current.userInterfaceIdiom == .phone && Screen.SCREEN_MAX_LENGTH() == 568.0
    }
    
    class func IS_IPHONE_6 () -> Bool{
        return UIDevice.current.userInterfaceIdiom == .phone && Screen.SCREEN_MAX_LENGTH() == 667.0
    }
    
    class func IS_IPHONE_6P () -> Bool{
        return UIDevice.current.userInterfaceIdiom == .phone && Screen.SCREEN_MAX_LENGTH() == 736.0
    }
    
    class func IS_IPHONE_X () -> Bool{
        return UIDevice.current.userInterfaceIdiom == .phone && Screen.SCREEN_MAX_LENGTH() == 812.0
    }
    
    class func IS_IPHONE_Xs_Max () -> Bool{
        return UIDevice.current.userInterfaceIdiom == .phone && Screen.SCREEN_MAX_LENGTH() == 896.0
    }
    
    class func IS_BELOW_IPHONE_Plus () -> Bool{
        return UIDevice.current.userInterfaceIdiom == .phone && Screen.SCREEN_MAX_LENGTH() <= 736.0
    }
}
extension Bundle {
